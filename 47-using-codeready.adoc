...
image::/images/codeready-operator.png[image]

- Click the `CodeReady` operator
- Click `Install`

image::/images/codeready-subscription.png[image]

- Select your newly created project as `A specific namespace`
- Click `Subscribe`
- Navigate `Installed Operators`

image::/images/codeready-installed.png[image]
...
image::/images/codeready-pods.png[image]

- Wait until all pods are `Running`
- Navigate to `Networking` -> `Routes`
- Click onto the URL under `LOCATION` for `codeready` route

image::/images/codereadyworkspace.png[image]

- Click `Register`

image::/images/codeready-register.png[image]
...
image::/images/codeready-starting.png[image]

image::/images/codeready-ready.png[image]

- Click `Project` from the top menu and select `Update Project Configuration`

image::/images/codeready-project.png[image]

- Click `Maven`
- Click `Save`

image::/images/codeready-run.png[image]
...
image::/images/springboot-result.png[image]

image::/images/codeready-preview.png[image]
...
image::/images/codeready-factory.png[image]

- Enter 'SpringBootSample' as name
- Click `Create` -> `Close`

image::/images/codeready-factory2.png[image]

- Click `Workspace` -> 'Stop'

image::/images/codeready-factory3.png[image]

- Click `Factory (1)` on the left menu
- Click onto `SpringBootSample`
- Scroll down and look for `Configure Actions`

image::/images/codeready-sample.png[image]

- Add `Buid and Run` to `runCommand` -> Click `Add`
- Click `Open`

image::/images/codeready-openfactory.png[image]

- Click `Back to Dashboard` at the bottom

image::/images/codereay-fromfactory.png[image]
...
image::/images/codeready-buildandrun.png[image]
