...
Currently using the OC client CLI from https://access.redhat.com/downloads/content/290. You can
...
....
[~] $ wget https://mirror.openshift.com/pub/openshift-v4/clients/ocp/4.2.7/openshift-client-linux-4.2.7.tar.gz
(...)
...
....
[~] $ wget https://mirror.openshift.com/pub/openshift-v4/clients/ocp/4.2.7/openshift-client-mac-4.2.7.tar.gz
(...)
...
OCP4 CLI login require the API URL (https://api.crc.testing:6443) not the master URL.

....
[~] $ oc login --server https://api.crc.testing:6443
