...
- Login to the cluster via https://api.crc.testing:6443
...
- Back to web console https://console-openshift-console.apps-crc.testing
...
- Go back to your web console https://console-openshift-console.apps-crc.testing
