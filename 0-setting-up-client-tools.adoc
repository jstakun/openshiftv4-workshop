...
** OSX
https://mirror.openshift.com/pub/openshift-v4/clients/ocp/4.2.7/openshift-client-mac-4.2.7.tar.gz

** Linux
https://mirror.openshift.com/pub/openshift-v4/clients/ocp/4.2.7/openshift-client-linux-4.2.7.tar.gz
...
** https://mirror.openshift.com/pub/openshift-v4/clients/ocp/4.2.7/openshift-client-windows-4.2.7.zip
